...
{ PCL_NONE, //int     classnum;
    ...
    { PCL_HUMAN_JEEP, //int     classnum;
        "human_jeep", //char    *classname;
        "jeep", //char    *humanname;
        "keel", //char    *modelname;
        1.0f, //float   modelScale;
        "default", //char    *skinname;
        ...
        1.0f, //float   fallDamage;
        0, //int     regenRate;
        SCA_TAKESFALLDAMAGE, //int     abilities;
        WP_NONE, //special-cased in g_client.c          //weapon_t  startWeapon
        110.0f, //float   buildDist;
        90, //int     fov;
        0.002f, //float   bob;
...
{ WP_MACHINEGUN, //int       weaponNum;
    ...
    { WP_PISTOL, //int       weaponNum;
        ...
        PISTOL_CLIPSIZE, //int       maxAmmo;
        PISTOL_MAXCLIPS, //int       maxClips;
        qfalse, //int       infiniteAmmo;
        qfalse, //int       usesEnergy;
        PISTOL_REPEAT, //int       repeatRate1;
        0, //int       repeatRate2;
        0, //int       repeatRate3;
        PISTOL_RELOAD, //int       reloadTime;
...
{ UP_LIGHTARMOUR, //int   upgradeNum;
	...
	/*{ UP_JEEP, //int   upgradeNum;
		JEEP_PRICE, //int   price;
		(1 << S1) | (1 << S2) | (1 << S3), //int  stages
		SLOT_HEAD | SLOT_TORSO | SLOT_ARMS | SLOT_LEGS | SLOT_BACKPACK, //int   slots;
		"jeep", //char  *upgradeName;
		"Jeep", //char  *upgradeHumanName;
		"icons/iconu_bsuit", qtrue, //qboolean purchasable
		qfalse, //qboolean usable
		WUT_HUMANS //WUTeam_t  team;
	},*/
