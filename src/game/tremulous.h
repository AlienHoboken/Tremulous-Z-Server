...
#define AXE_RANGE               80.0f
#define AXE_WIDTH               16.0f
#define AXE_SPEED               420

#define PISTOL_CLIPSIZE             16
#define PISTOL_MAXCLIPS             999
#define PISTOL_RELOAD               2000
#define PISTOL_PRICE               0
#define PISTOL_REPEAT              300
#define PISTOL_K_SCALE             6.0f
#define PISTOL_DAMAGE              HDM(10)
...
#define ROCKET_LAUNCHER_PRICE               750
#define ROCKET_LAUNCHER_REPEAT              600
#define ROCKET_LAUNCHER_AMMO                10
#define ROCKET_LAUNCHER_K_SCALE             5.0f
#define ROCKET_LAUNCHER_DAMAGE              HDM(150)
#define ROCKET_LAUNCHER_RANGE               160.0f
...
#define LEVEL_PAUSE 10000 //Time in ms to pause the spawning between levels.
