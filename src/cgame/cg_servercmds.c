...
void CG_SetConfigValues( void )
{
  ...
  sscanf( CG_ConfigString( CS_ZOMBIERECORDS ),
  "%d %d %d", &cgs.survivalRecords[0], &cgs.survivalRecords[1], &cgs.survivalRecords[2]);
...
static void CG_ConfigStringModified( void )
{
  ...
  else if( num == CS_ZOMBIERECORDS )
    sscanf( str, "%d %d %d", &cgs.survivalRecords[0], &cgs.survivalRecords[1], &cgs.survivalRecords[2] );
