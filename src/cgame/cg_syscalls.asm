...
equ trap_Parse_AddGlobalDefine        -101
equ trap_Parse_LoadSource             -102
equ trap_Parse_FreeSource             -103
equ trap_Parse_ReadToken              -104
equ trap_Parse_SourceFileAndLine      -105
